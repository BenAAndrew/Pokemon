...
public class Music implements OnCompletionListener, OnPreparedListener {
    ...
    public void play() {
        ...
        } catch (Exception e) { // Either cIllegalStateExeption or IOException
            throw new RuntimeException(
     ...
     */
    public void setVolume(float volume) { mMediaPlayer.setVolume(volume, volume); }
    ...
    public boolean isPlaying() {
        return mMediaPlayer.isPlaying() || mIsPrepared;
    }
